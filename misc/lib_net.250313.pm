...
sub takeUpDeviceOk {
	...
	my $szTakeItUp = "ip link set ".$szInternal." up";
     	...
     	my $res = `$szTakeItUp`;
     	print "***** Response from taking up $szInternal:\n$res\n"; 
     	sleep 2;
...
sub setupWifiNicAsHotspot {
    ...
    my $ssid = "Taransvar Hotspot ($szName)";
    ...
    run_command("sudo apt install iw hostapd -y");
