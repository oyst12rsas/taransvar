...
-- Apply on a gateway with:
--   sudo mysql taransvar < misc/unit_app_token.sql
-- This deliberately does not change setup.dbVersion yet; fold it into the next
-- normal schema migration once pairing has been validated operationally.
