...
.http-demo-card h2{margin-top:0}.http-demo-card a{display:inline-block;padding:8px 11px;border:1px solid #777;background:#f8f8f8;text-decoration:none}.http-demo-note{margin-top:18px;padding:12px;border:1px solid #ddd;background:#fafafa}
</style>
...
<div class="http-demo-grid">
 <div class="http-demo-card">
  ...
  <a href="<?php print htmlspecialchars($demo1Url, ENT_QUOTES, 'UTF-8'); ?>">Open Demo 1</a>
 </div>
 <div class="http-demo-card">
  <h2>Demo 2</h2>
  <p>SSH rejection at Node A, gateway infection evidence, and legitimate Node B clearing.</p>
  <a href="<?php print htmlspecialchars($dbBase.'appDemo2', ENT_QUOTES, 'UTF-8'); ?>">Open Demo 2</a>
 </div>
 <div class="http-demo-card">
  <h2>Demo 3</h2>
  <p>Community Request for Assistance, containment evidence, release and recovery.</p>
  <a href="<?php print htmlspecialchars($dbBase.'appDemo3', ENT_QUOTES, 'UTF-8'); ?>">Open Demo 3</a>
 </div>
 <div class="http-demo-card">
  <h2>Demo 4</h2>
  <p>Tagged traffic routed through a selected partner ISP router with a recognizable public address.</p>
  <a href="<?php print htmlspecialchars($dbBase.'appDemo4', ENT_QUOTES, 'UTF-8'); ?>">Open Demo 4</a>
 </div>
</div>
