...
<h1>HTTP Demo 2 — SSH rejection and clearing</h1>
<p class="gk-demo-help"><b>This page runs the browser version of Android Demo 2.</b> It uses the same authoritative session API and configured Roquefort → Camembert path. The two SSH connections still run in your SSH client.</p>
<?php
    $c=null;
    try {
        $c=getConnection();
...
<p class="gk-demo-actions"><a href="index.php?f=appDemo2">Refresh</a><a href="index.php?f=appDemos">Back to HTTP demos</a></p>
<?php
        $c->close();
    } catch(Throwable $e){
        if($c) $c->close();
