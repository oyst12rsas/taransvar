        ...
        <div class="container py-5">
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="mailto:contact@taransvar.com" class="btn btn-primary">
    ...
    <script>
        ...
        if (paymentModal) {
            paymentModal.addEventListener('show.bs.modal', function (event) {
                ...
                document.getElementById('planPrice').textContent = `KSh ${price}`;
                document.getElementById('modalAmount').textContent = `KSh ${price}`;
            });
        }
    </script>
</body>
