...
function getTheTag($szIp, $szPort)
{
    ...
    $szSQL = "select coalesce(tag,'') as tag from traffic where ipFrom = inet_aton(?) and lastSeen > NOW() - INTERVAL 1 HOUR order by tag desc limit 1";
