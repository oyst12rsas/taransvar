...
CREATE TABLE `internalInfections` (
  ...
  `ip` int(10) unsigned NOT NULL,
  `nettmask` int(10) unsigned NOT NULL DEFAULT conv('FFFFFFFF',16,10),
...
CREATE TABLE `session` (
  ...
  PRIMARY KEY (`sessionid`)
) ENGINE=InnoDB AUTO_INCREMENT=421 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
CREATE TABLE `setup` (
...
) ENGINE=InnoDB AUTO_INCREMENT=20872 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
CREATE TABLE `unit` (
...
) ENGINE=InnoDB AUTO_INCREMENT=4607 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
CREATE TABLE `user` (
